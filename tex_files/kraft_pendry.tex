\subsection{Plasmonic gratings considered in \cite{pendry2016acsphotonics} behaving as bianisotropic metamaterial}
...
\includegraphics[width=\textwidth]{critical_xi_vs_real_epsilon_pendry_inf_sup.eps}
\end{subfigure}
%
\begin{subfigure}[b]{0.49\textwidth}
\centering
\includegraphics[width=\textwidth]{critical_xi_vs_imag_epsilon_pendry_inf_sup.eps}
\end{subfigure}
...
\centering
\begin{subfigure}[b]{0.49\textwidth}
\includegraphics[width=\textwidth]{critical_xi_vs_real_epsilon_pendry_uniqueness.eps}
\end{subfigure}
%
\begin{subfigure}[b]{0.49\textwidth}
\centering
\includegraphics[width=\textwidth]{critical_xi_vs_imag_epsilon_pendry_uniqueness.eps}
\end{subfigure}
